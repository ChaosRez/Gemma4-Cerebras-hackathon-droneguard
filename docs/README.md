...
3. [Cerebras integration notes](./CEREBRAS_INTEGRATION.md) - model ID, linked docs, request patterns, Pydantic AI runtime option, Arize Phoenix tracing, reasoning, image inputs, and validation caveats.
4. [Data contracts](./DATA_CONTRACTS.md) - telemetry CSV fields and structured JSON outputs expected from agents.
5. [Web app and observability](./WEB_APP_AND_OBSERVABILITY.md) - browser UI requirements, simulator integration, local traces, Phoenix status, logs, and cached replay.
